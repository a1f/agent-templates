...
*What / Counted lines / Blocked by / Status / Done when*). Rows only, no coder
prompts; PRs stay at ~35 counted lines of code (added lines excluding tests,
lockfiles, and generated or vendored output) and 100 of prose — the size gate
refuses over 50 code lines across 3+ code files that add lines, over 100 across
1–2, and over 150 of prose. Edits here change the table but not its PR-map
